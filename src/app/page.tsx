...
export default function Home() {
  ...
  const hardSkills = [
    ...
    {displayName: "API", aliases: ["API", "APIs", "API's"]},
    {displayName: "AWS", aliases: ["AWS"]},
    {displayName: "Content Management System", aliases: ["content management system", "content management systems", "CMS"]},
    ...
    {displayName: "JavaScript", aliases: ["javascript", "java script"]},
    {displayName: "Jest", aliases: ["jest"]},
    {displayName: "jQuery", aliases: ["jquery"]},
    {displayName: "JSON", aliases: ["json"]},
    ...
    {displayName: "Next.js", aliases: ["next", "nextjs", "next.js"]},
    {displayName: "NodeJS", aliases: ["nodejs", "node.js"]},
    {displayName: "NPM", aliases: ["npm", "node package manager"]},
    ...
    {displayName: "SCSS", aliases: ["scss", "sass"]},
    ...
    {displayName: "TypeScript", aliases: ["typescript", "type script"]},
    ...
    {displayName: "Wordpress", aliases: ["wordpress", "wordpress themes"]},
    ...
    {displayName: "React Hooks", aliases: ["react hooks"]},
    {displayName: "ES6", aliases: ["es6"]},
    {displayName: "Babel", aliases: ["babel"]},
    {displayName: "webpack", aliases: ["webpack"]},
    {displayName: "Storybook", aliases: ["storybook"]},
    ...
    {displayName: "Figma", aliases: ["figma"]},
